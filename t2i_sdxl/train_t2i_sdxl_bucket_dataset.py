...
class ComicDatasetBucket(Dataset):
    def __init__(self, file_path, max_size=(1024,1024), divisible=64, stride=16, min_dim=512, base_res=(1024,1024), max_ar_error=4, dim_limit=2048):
    ...
    def get_resolution(self, file_path):
        ...
        # self.prompt_embeds = np.load("/root/code/diffusers/real_human_laion_danbooru_example_1500.npy")
        # self.pooled_prompt_embeds = np.load("/root/code/diffusers/real_human_laion_danbooru_example_1500_2.npy")
    ...
    def __getitem__(self, idx):
        ...
        # pooled_prompt_embeds = self.pooled_prompt_embeds[idx]
        ...
        return dict(pixel_values=target, conditioning_pixel_values=source, original_sizes=(ori_W, ori_H), crop_top_lefts=(0, 0), target_sizes=(W, H), \
